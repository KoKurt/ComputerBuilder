...
namespace ComputerBuilder.Logic.Services
{
    ...
    {
        private readonly ComputerBuilderDBContext _dbContext = null;
        public UserService(ComputerBuilderDBContext appDbContext)
        {
        ...
        public ResponseModel RegisterUser(RegisterModel registerModel)
        {
            ...
            {
                response.Status = false;
                response.Message = "An Error has ocurred. Please Try again!";
        ...
        public ResponseModel LoginUser(LoginModel loginModel)
        {
            ...
            {
                response.Status = false;
                response.Message = "An Errror has occured. Please try again!";
                return response;
            }
        }
